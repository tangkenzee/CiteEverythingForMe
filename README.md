...
- **Agent & tools**: ConnectOnion agent (`src/agent/my_agent/app.py`) exposes tools for sharing the request payload, hitting the CiteAs API, scraping with Trafilatura when required, and formatting UNSW citations; learn the workflow in `agent_prompt.md`.
